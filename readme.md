# Vehicle Model Detection Dataset 9800 images YOLO format supported fully annotated.

# Body

Vehicle Detection Dataset, 9800 images, YOLO format supported, fully annotated, ready to use for target detection, vehicle recognition, autonomous driving projects.
for .
For those in need, please place the order directly. Details can be privately messaged for.

Note
SUV, Sedan, Microbus, Minivan, Truck, Bus
